...
export const person = pgTable(
  'person',
  {
    ...
    // and no other register collects - docs/specs/03-data-model.md §"Contact and post
    ...
    // operators states one post across both. the cost is recorded in the spec section; no
